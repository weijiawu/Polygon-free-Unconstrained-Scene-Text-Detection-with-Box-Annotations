...
def eval_2015(res_folder,gt_name):
    ...
    params['g'] = gtfile
    params['s'] = submitfile
    methodHmean = rrc_evaluation_funcs.main_evaluation(params, default_evaluation_params, validate_data, evaluate_method)
...
def getresult(path,gt_name):
    ...
    #eval_2015('../../test')
    f_score_new = eval_2015(path,gt_name)
    return f_score_new

if __name__=='__main__':
        
    # rrc_evaluation_funcs.main_evaluation(None,default_evaluation_params,validate_data,evaluate_method)
    getresult("/data/data_weijiawu/Sence_Text_detection/Paper-ACCV/DomainAdaptive/ICDAR2015/EAST_v1/ICDAR15/Test/submit/")