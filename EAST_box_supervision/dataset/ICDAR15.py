...
if __name__ == "__main__":
    ...
    train_img_path = os.path.abspath('/data/glusterfs_cv_04/11121171/data/ICDAR2015/train_image')
    train_gt_path = os.path.abspath("/data/glusterfs_cv_04/11121171/data/ICDAR2015/train_gt")
    ...
    trainset = ICDAR15(model,train_img_path,train_gt_path)
