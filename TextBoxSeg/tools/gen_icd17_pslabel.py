...
debug_flag = True
img_save_path = '/home/xjc/Dataset/icdar17/box_supervision/show/'
...
def demo():
    ...
    if os.path.exists('/home/xjc/Dataset/icdar17/'):
        ic17_root_path = '/home/xjc/Dataset/icdar17/'
    else:
        ic17_root_path = '/home/xjc/Dataset/icdar17/'
    ic17_train_data = ic17_root_path + 'train_image'
    ic17_train_gt = ic17_root_path + 'train_gt'
    assert os.path.exists(ic17_train_data) and os.path.exists(ic17_train_gt)

    '''bbox + pseudo box '''
    ic15_train_gt_bbox = ic17_root_path + 'box_supervision/gt_bbox'
    ic15_train_gt_pseudobox = ic17_root_path + 'box_supervision/gt_pseudo'
    ...
    num_ic15_imgs = 7200
    image_list = os.listdir(ic17_train_data)
    #遍历图片
    for idx,image in tqdm(enumerate(image_list)):
        i = image.split("_")[-1].split(".")[0]
        img_path = image
        img_path = os.path.join(ic17_train_data, img_path)

        gt_path = 'gt_img_{}.txt'.format(i)
        gt_path = os.path.join(ic17_train_gt, gt_path)
