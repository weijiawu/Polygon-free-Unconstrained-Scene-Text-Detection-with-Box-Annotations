...
def demo():
    ...
    # output folder
    output_dir = 'demo/trash/ICDAR19ArT'
    ...
    ic15_train_data = '/data/data_weijiawu/ICDAR2019_Art/train_images/train_images/'
    ic15_train_gt =  '/data/data_weijiawu/ICDAR2019_Art/train_labels.json'
