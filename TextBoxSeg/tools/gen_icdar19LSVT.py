...
def demo():
    ...
    total_root_path = '/data/data_weijiawu/ICDAR2019LSVT/'

    img_save_path = "./demo/trash/Icdar19_lsvt"
    ic19_train_data = '/data/data_weijiawu/ICDAR2019LSVT/train/'
    ic19_train_gt = '/data/data_weijiawu/ICDAR2019LSVT/train_full_labels.json'
