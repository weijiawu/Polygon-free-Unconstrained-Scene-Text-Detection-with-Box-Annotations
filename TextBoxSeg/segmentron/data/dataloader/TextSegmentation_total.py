...
from .seg_data_base import SegmentationDataset_total
# from IPython import embed
import cv2

class TextSegmentation_total(SegmentationDataset_total):
    ...
    def __init__(self, root='data/st800k_crop', split='train', mode=None, transform=None, debug=False, **kwargs):
        super(TextSegmentation_total, self).__init__(root, split, mode, transform, **kwargs)
