...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    return resDict, methodHmean,methodPrecision,methodRecall;


def eval_2015(res_folder,gt_name):
    params = {}
    ...
    zip.close()
    gtfile = os.path.join(current_folder, gt_name)
    params['g'] = gtfile
    params['s'] = submitfile
    resDict, methodHmean,methodPrecision,methodRecall = rrc_evaluation_funcs.main_evaluation(params, default_evaluation_params, validate_data,
                                                                evaluate_method)

    return methodHmean,methodPrecision,methodRecall


def getresult(path,gt_name):
    # rrc_evaluation_funcs.main_evaluation(None, default_evaluation_params, validate_data, evaluate_method)
    # eval_2015('../../test')
    methodHmean,methodPrecision,methodRecall = eval_2015(path,gt_name)
    return methodHmean,methodPrecision,methodRecall
...
if __name__ == '__main__':
    # rrc_evaluation_funcs.main_evaluation(None,default_evaluation_params,validate_data,evaluate_method)
    getresult(
        "/data/data_weijiawu/Sence_Text_detection/Paper-ACCV/DomainAdaptive/ICDAR2015/EAST_v1/ICDAR15/Test/submit/")